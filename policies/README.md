...
`cli/templates/project.compose.yml.tmpl` by the `moor` CLI):
...
2. **Active breakout battery** (live probes inside the container): tries
   ...
   `moor audit`, not just a console message that scrolls away.
